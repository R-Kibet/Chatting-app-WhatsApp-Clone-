...
public class SignActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                            ...
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (task.isSuccessful()){
                                        ...
                                        //after creating the model package for user tasks
                                        //get the txt and covert it to string
                                        //stored in the user
                                        ...
                                        // Extract or get uer id from the database
                                        //introduction of task variable
        ...
        //initializing already have an account & setting onclick listenrr
